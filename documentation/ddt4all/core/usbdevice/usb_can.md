...
`UsbCan` is part of the ddt4all core layer.
...
Creates a `UsbCan` instance and sets its starting state.
...
This summary shows the usual high-level flow through `UsbCan`.
