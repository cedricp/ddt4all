...
class requestEditor(widgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.checknosds = widgets.QCheckBox("No SDS")
        self.checkplant = widgets.QCheckBox("Plant")
        self.checkaftersales = widgets.QCheckBox("After Sale")
        self.checkengineering = widgets.QCheckBox("Engineering")
        self.checksupplier = widgets.QCheckBox("Supllier")
...
class ecuParamEditor(widgets.QFrame):
    def __init__(self, parent=None):
        ...
        autoident_label = widgets.QLabel("ECU Auto identification")
