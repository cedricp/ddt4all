...
class Ecu_list(widgets.QWidget):
    def __init__(self, ecuscan, treeview_ecu):
        ...
        self.ecu_map = {}
        vehicles = [
            "ALL", "X06 - Twingo", "X07 - Twingo", "X07PH2 - Twingo", "X09 - Twizy", "X1316 - R5", "X10 - Zoe",
            "XCB - [Zoe]", "X10PH2 - Zoe", "X33 - Wind", "X44 - Twingo", "X44PH2 - Twingo", "XBA - Kwid",
            "XBG - Kwid", "XBB - Kwid", "X35 - Symbol", "X65 - Clio", "XBC - New", "X77 - Modus", "X77PH2 - Modus",
            "X87 - Captur", "X87PH2 - Captur", "X85 - Clio", "X98 - Clio", "X98PH2 - Clio", "XJA - Clio",
            "XFI - C-Hatch", "X64 - Megane", "XJF - Logan", "XCC - New", "XCD - New", "X84 - Megane",
            "X84BUGABS - Megane", "X84ABSONLY - Megane", "X84PH2 - Megane", "X95 - Megane", "X95PH2 - Megane",
            "X38 - Fluence", "XJL - Fluence", "XJH - xJH", "XFA - Scenic", "XFAPH2 - Scenic", "XFB - Megane",
            "XFBPH2 - Megane", "HFEPH2 - Kadjar", "XHN - [SUV]", "XHC - [SUV]Chine", "HFE - Kadjar", "XFF - Megane",
            "XFFPH2 - Megane", "XFJ - (x38_Chine)", "XEF - Alpine", "XJB - New", "XJBPH2 - New", "XJP - [Captur]",
            "XJE - New", "XZH - Kadjar", "XZHPH2 - Kadjar", "X56 - Laguna", "X66 - Avantime", "XZG - Koleos",
            "XZI - Kadjar", "XZGPH2 - Koleos", "XZJ - Koleos", "XZJPH2 - Koleos", "X74 - Laguna", "X74PH2 - Laguna",
            "X47 - Laguna", "X91 - Laguna", "X91PH2 - Laguna", "X91PH3 - Laguna", "X96 - (X96)", "XFD - Talisman",
            "XFDPH2 - Talisman", "X43 - Latitude", "X54 - Safrane", "X73 - VelSatis", "X73PH2 - VelSatis",
            "X81 - Espace", "X81PH2 - Espace", "X81PH3 - Espace", "X81PH4 - Espace", "X94 - (x94)", "XFC - Espace",
            "XFCPH2 - Espace", "XFG - (xFG)", "X70 - Master", "X70PH3 - Master", "X76 - Kangoo", "XFK - New",
            "XJK - Docker", "X61 - Kangoo", "U60 - Alaskan", "X61PH2 - Kangoo", "X82 - Trafic", "X82PH2 - Trafic",
            "X83 - Trafic", "X83PH2 - Trafic", "X83PH3 - Trafic", "X62 - Master", "X62PH2 - Master", "XDC - Master",
            "XDD - Master", "X24 - Mascott", "X89 - (X89)", "X52 - Logan", "XJI - Logan", "X92 - Lodgy",
            "XHA - Kaptur", "XHAPH2 - Kaptur", "XGA - BM", "X79 - Duster", "X79PH2 - Duster", "X1310 - Duster",
            "XJC - Arkana", "XJD - Duster", "X90 - Logan", "NOVA - Nova", "X67 - Docker", "AS1 - A110",
            "MARCH - March/Micra", "PRIMERA - Primera", "ALMERA - Almera", "PZ1A - [Leaf]", "PZ1C - [PZ1C]",
            "X02E - Micra", "X21B - Note", "L21B - Note", "X13A - [Juke]", "PY1B - (PY1B)", "P32 - (P32)",
            "X60A - Navarra", "XNN - (PB1D)", "LZ2A - New", "P33A - (P33A)", "P33B - (P33B)", "P42Q - (P42Q)",
            "P42R - (P42R)", "J32V - (J32V)", "RF90 - Largus", "XGF - Vesta", "XJN - (XJN)", "XJO - (XJO)",
            "KJA - KJA", "H45 - Koleos", "W176 - (w176)", "X60B - Andrew", "W205 - (w205)", "VS10 - Citan",
            "VS11 - New", "EDISON - X07", "XPIV_C1A - DDT-Training", "XPIV_C1AHS - DDT-Training",
            "XCOP_BEFORE_C1A - Contrôle", "XCOP_C1A - Contrôle", "XCOP_C1AHS - Contrôle"
        ]
