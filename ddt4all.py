...
class Ecu_list(widgets.QWidget):
    def __init__(self, ecuscan, treeview_ecu):
        ...
        self.ecu_map = {}
        vehicles = [
            "ALL", "X06 - Twingo", "X07 - Twingo III", "X07PH2 - Twingo III Ph2", "X09 - Twizy", "X1316 - R5 Elec",
            "X10 - Zoe", "XCB - [Zoe]", "X10PH2 - Zoe (C1A-Neo)", "X33 - Wind", "X44 - Twingo II",
            "X44PH2 - Twingo II Phase2", "XBA - Kwid", "XBG - Kwid EV", "XBB - Kwid BR", "X35 - Symbol / Thalia",
            "X65 - Clio II", "XBC - New Captur India", "X77 - Modus", "X77PH2 - Modus Phase2", "X87 - Captur",
            "X87PH2 - Captur Phase 2", "X85 - Clio III", "X98 - Clio IV", "X98PH2 - Clio IV Phase 2",
            "XJA - Clio (C1A)", "XFI - C-Hatch China (C1A)", "X64 - Megane &amp; Scenic",
            "XJF - Logan III Badge Renault", "XCC - New EV (C1A HS Evo Sweet400)",
            "XCD - New EV China version (C1A HS Evo Sweet400)", "X84 - Megane II", "X84BUGABS - Megane II hors ABS",
            "X84ABSONLY - Megane II only ABS", "X84PH2 - Megane II Phase 2", "X95 - Megane III",
            "X95PH2 - Megane III Phase 2", "X38 - Fluence", "XJL - Fluence Korea", "XJH - xJH", "XFA - Scenic IV",
            "XFAPH2 - Scenic IV phase2", "XFB - Megane IV", "XFBPH2 - Megane IV Ph2", "HFEPH2 - Kadjar Ph2",
            "XHN - [SUV]", "XHC - [SUV]Chine", "HFE - Kadjar", "XFF - Megane IV Sedan", "XFFPH2 - Megane IV Sedan Ph2",
            "XFJ - (x38_Chine)", "XEF - Alpine A110", "XJB - New Captur (C1A)", "XJBPH2 - New Captur (C1A)Ph2",
            "XJP - [Captur]", "XJE - New Captur (Chine)", "XZH - Kadjar CN", "XZHPH2 - Kadjar CN Ph2", "X56 - Laguna",
            "X66 - Avantime", "XZG - Koleos II", "XZI - Kadjar Rus", "XZGPH2 - Koleos II Ph2",
            "XZJ - Koleos II (Chine)", "XZJPH2 - Koleos II (Chine) Ph2", "X74 - Laguna II",
            "X74PH2 - Laguna II Phase 2", "X47 - Laguna III Tricorps", "X91 - Laguna III",
            "X91PH2 - Laguna III Phase 2", "X91PH3 - Laguna III Phase 3", "X96 - (X96)",
            "XFD - Talisman", "XFDPH2 - Talisman Phase II", "X43 - Latitude", "X54 - Safrane", "X73 - VelSatis",
            "X73PH2 - VelSatis Phase 2", "X81 - Espace IV", "X81PH2 - Espace IV Phase 2", "X81PH3 - Espace IV Phase 3",
            "X81PH4 - Espace IV Phase 4", "X94 - (x94)", "XFC - Espace V", "XFCPH2 - Espace V Ph2", "XFG - (xFG)",
            "X70 - Master II", "X70PH3 - Master II Phase 3", "X76 - Kangoo", "XFK - New Kangoo", "XJK - Docker II",
            "X61 - Kangoo II", "U60 - Alaskan (u55, xND)", "X61PH2 - Kangoo II Phase 2", "X82 - Trafic III",
            "X82PH2 - Trafic III Phase2", "X83 - Trafic II", "X83PH2 - Trafic II Phase 2",
            "X83PH3 - Trafic II Phase 3", "X62 - Master III", "X62PH2 - Master III Phase 2", "XDC - Master Chine",
            "XDD - Master IV", "X24 - Mascott", "X89 - (X89)", "X52 - Logan", "XJI - Logan III", "X92 - Lodgy",
            "XHA - Kaptur Captur (BAR/IN/RU)", "XHAPH2 - Kaptur Captur (BAR/IN/RU) Ph2", "XGA - BM Lada",
            "X79 - Duster", "X79PH2 - Duster Phase 2", "X1310 - Duster II", "XJC - Arkana", "XJD - Duster Phase 3",
            "X90 - Logan / Sandero", "NOVA - Nova", "X67 - Docker Kangoo", "AS1 - A110", "MARCH - March/Micra",
            "PRIMERA - Primera", "ALMERA - Almera", "PZ1A - [Leaf]", "PZ1C - [PZ1C]", "X02E - Micra", "X21B - Note",
            "L21B - Note", "X13A - [Juke]", "PY1B - (PY1B)", "P32 - (P32)", "X60A - Navarra (xND)", "XNN - (PB1D)",
            "LZ2A - New EV (C1A HS EVO) SWEET 400 Nissan)", "P33A - (P33A)", "P33B - (P33B)", "P42Q - (P42Q)",
            "P42R - (P42R)", "J32V - (J32V)", "RF90 - Largus", "XGF - Vesta", "XJN - (XJN)", "XJO - (XJO)",
            "KJA - KJA", "H45 - Koleos", "W176 - (w176)", "X60B - Andrew (xMZ, xNE)", "W205 - (w205)", "VS10 - Citan",
            "VS11 - New Citan", "EDISON - X07 Daimler", "XPIV_C1A - DDT-Training C1A",
            "XPIV_C1AHS - DDT-Training C1A HS", "XCOP_BEFORE_C1A - Contrôle COP Before C1A",
            "XCOP_C1A - Contrôle COP C1A", "XCOP_C1AHS - Contrôle COP C1A HS"
        ]
