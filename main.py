...
class Ecu_list(widgets.QWidget):
    def __init__(self, ecuscan, treeview_ecu):
        ...
        self.ecu_map = {}
        vehicles = [
            "ALL", "J32V - (J32V)", "P32 - (P32)", "P33A - (P33A)", "P33B - (P33B)", "P42Q - (P42Q)", "P42R - (P42R)",
            "XNN - (PB1D)", "PY1B - (PY1B)", "W176 - (w176)", "W205 - (w205)", "XFJ - (x38_Chine)", "X89 - (X89)",
            "X94 - (x94)", "X96 - (X96)", "XFG - (xFG)", "XJN - (XJN)", "XJO - (XJO)", "XJP - [Captur]",
            "X13A - [Juke]", "PZ1A - [Leaf]", "PZ1C - [PZ1C]", "XHN - [SUV]", "XHC - [SUV]Chine", "XCB - [Zoe]",
            "AS1 - A110", "U60 - Alaskan/(u55, xND)", "ALMERA - Almera", "XEF - Alpine A110",
            "X60B - Andrew (xMZ, xNE)", "XJC - Arkana", "X66 - Avantime", "XGA - BM Lada", "XFI - C/Hatch China (C1A)",
            "X87 - Captur", "X87PH2 - Captur Phase 2", "VS10 - Citan", "XJA - Clio (C1A)", "X65 - Clio II",
            "X85 - Clio III", "X98 - Clio IV", "X98PH2 - Clio IV Phase 2", "XCOP_BEFORE_C1A - Contrôle COP Before C1A",
            ...
            "X1310 - Duster II", "X79PH2 - Duster Phase 2", "XJD - Duster Phase 3", "X81 - Espace IV",
            "X81PH2 - Espace IV Phase 2", "X81PH3 - Espace IV Phase 3", "X81PH4 - Espace IV Phase 4", "XFC - Espace V",
            "XFCPH2 - Espace V Ph2", "X38 - Fluence", "XJL - Fluence/Korea", "HFE - Kadjar", "XZH - Kadjar CN",
            "XZHPH2 - Kadjar CN Ph2", "HFEPH2 - Kadjar Ph2", "XZI - Kadjar Rus", "X76 - Kangoo", "X61 - Kangoo II",
            "X61PH2 - Kangoo II Phase 2", "XHA - Kaptur/Captur (BAR/IN/RU)", "XHAPH2 - Kaptur/Captur (BAR/IN/RU) Ph2",
            "KJA - KJA", "H45 - Koleos", "XZG - Koleos II", "XZGPH2 - Koleos II Ph2", "XZJ - Koleos II/Chine",
            "XZJPH2 - Koleos II/Chine Ph2", "XBA - Kwid", "XBB - Kwid BR", "XBG - Kwid EV", "X56 - Laguna",
            "X74 - Laguna II", "X74PH2 - Laguna II Phase 2", "X91 - Laguna III", "X91PH2 - Laguna III Phase 2",
            "X91PH3 - Laguna III Phase 3", "X47 - Laguna III Tricorps", "RF90 - Largus", "X43 - Latitude",
            "X92 - Lodgy", "X52 - Logan", "XJI - Logan III", "XJF - Logan III Badge Renault", "X90 - Logan/Sandero",
            "MARCH - March/Micra", "X24 - Mascott", "XDC - Master Chine", "X70 - Master II",
            "X70PH3 - Master II Phase 3", "X62 - Master III", "X62PH2 - Master III Phase 2", "XDD - Master IV",
            "X64 - Megane &amp; Scenic", "X84 - Megane II", "X84BUGABS - Megane II hors ABS",
            "X84ABSONLY - Megane II only ABS", "X84PH2 - Megane II Phase 2", "X95 - Megane III",
            "X95PH2 - Megane III Phase 2", "XFB - Megane IV", "XFBPH2 - Megane IV Ph2", "XFF - Megane IV/Sedan",
            "XFFPH2 - Megane IV/Sedan Ph2", "X02E - Micra", "X77 - Modus", "X77PH2 - Modus Phase2",
            "X60A - Navarra (xND)", "XJB - New Captur (C1A)", "XJBPH2 - New Captur (C1A)Ph2",
            "XJE - New Captur (Chine)", "XBC - New Captur India", "VS11 - New Citan",
            "LZ2A - New EV ((C1A HS EVO) SWEET 400 Nissan)", "XCC - New EV (C1A HS Evo Sweet400)",
            "XCD - New EV China version (C1A HS Evo Sweet400)", "XFK - New Kangoo", "X21B - Note", "L21B - Note",
            "NOVA - Nova", "PRIMERA - Primera", "X1316 - R5 Elec", "X54 - Safrane", "XFA - Scenic IV",
            "XFAPH2 - Scenic IV phase2", "X35 - Symbol/Thalia", "XFD - Talisman", "XFDPH2 - Talisman Phase II",
            "X83 - Trafic II", "X83PH2 - Trafic II Phase 2", "X83PH3 - Trafic II Phase 3", "X82 - Trafic III",
            "X82PH2 - Trafic III Phase2", "X06 - Twingo", "X44 - Twingo II", "X44PH2 - Twingo II Phase2",
            "X07 - Twingo III", "X07PH2 - Twingo III Ph2", "X09 - Twizy", "X73 - VelSatis", "X73PH2 - VelSatis Phase 2",
            "XGF - Vesta", "X33 - Wind", "EDISON - X07 Daimler", "XJH - xJH", "X10 - Zoe", "X10PH2 - Zoe (C1A/Neo)"
        ]
