#!/usr/bin/env python3
"""
i18n.py — remplace pot_create.bat / po_merge.bat / po_to_mo.bat / po2mo.bat
Changement:
  - suppression de --auto-include
  - les .mo sont générés uniquement dans --generated-dir (par défaut: src/ddt4all/generated)
  - ajout commande full-gen: pot-create -> po-merge -> po-to-mo
